...
Este trabajo se clasifica como un estudio aplicado porque tiene el objetivo de implementarse y demostrar su eficacia en entornos reales. /* cita */ Según #pc([@sampieri2014]), las investigaciones aplicadas son aquellas que buscan resolver problemas prácticos y específicos de la realidad, para servir como insumo clave en la toma de decisiones o a la solución de situaciones concretas en contextos determinados.

=== Enfoque // mixto
/* explicación */ Esta investigación tiene usa un enfoque mixto porque los indicadores tiempo de diagnóstico y precisión de diagnostico son de tipo cuantitativo, mientras que el indicador de satisfacción del médico es de tipo cualitativo. /* cita */ De acuerdo con #pc([@creswell2009]), existen tres tipos de enfoque: el cualitativo, que es un enfoque destinado a revelar el sentido que los individuos o grupos otorgan a una problemática de índole social o humana; el cuantitativo, que busca probar teorías examinando la relación entre variables medidas con instrumentos y analizadas estadísticamente; y el mixto, que se sitúa en un punto intermedio porque integra componentes tanto del enfoque cualitativo como del cuantitativo.

=== Diseño // Experimental (cuasi experimental)
/* explicación */ Este estudio adopta un diseño cuasi-experimental, ya que tiene como propósito medir los resultados obtenidos tras la aplicación de una intervención en dos grupos principales, mediante mediciones realizadas antes y después de la misma. /* cita */ Como señala #pc([@shadish2002]), el diseño cuasi-experimental se identifica por intentar establecer relaciones causales cuando no es posible asignar aleatoriamente a los participantes a los grupos de comparación, utilizando en su lugar otros métodos para controlar amenazas a la validez interna.

=== Nivel / Alcance // Explicativo
/* explicación */ El estudio que se presenta es explicativo ya que busca comprender cómo los modelos de deep learning pueden identificar la presencia de neumonía en imágenes médicas. /* cita */ Según #pc([@guevara2020]), la investigación explicativa se enfoca en establecer relaciones de causa y efecto, y no se limita a describir o explorar un fenómeno, sino que intenta descubrir los factores que lo provocaron.
