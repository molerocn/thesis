...
Durante esta etapa se analizar el impacto de lo objetivos del proyecto teniendo en cuenta les restricciones de un ambiente privado como una clínica, además de explicar por que se considera una futura transición al paradigma de aprendizaje federado.
